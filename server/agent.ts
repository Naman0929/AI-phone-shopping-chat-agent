                ...
                try{
                    ...
                    if (totalCount === 0) {
                        ...
                        return JSON.stringify({
                            error: "No items ound in inventory",
        ...
        async function callModel(state: typeof GraphState.State) {
            ...
            const prompt = ChatPromptTemplate.fromMessages([
                [
                    ...
                    ALWAYS use this tool when customers ask about Mobile Phone models, even if the tool returns errors 
                    or empty results.

                    When using the item_lookup tool:
                    - If it returns results, provide helpful details about the mobile phone models
